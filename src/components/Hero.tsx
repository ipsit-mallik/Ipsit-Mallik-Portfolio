  ...
  return (
    <section id="home" className="section relative overflow-hidden flex items-center">
      ...
      >
        ...
        <div
          className="absolute inset-0 bg-gradient-to-br from-background via-transparent to-card/20"
        />
        <div
            className="absolute -top-1/2 left-1/2 -z-10 h-[150%] w-[150%] -translate-x-1/2 rounded-full bg-primary/10 opacity-20 blur-3xl"
        />
      </div>
